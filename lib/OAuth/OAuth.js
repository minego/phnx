...
OAuth.setProperties(OAuth, // utility functions
{
    ...
    completeRequest: function completeRequest(message, accessor) {
        ...
        if (map.oauth_consumer_key == null) {
				// 21-NOV-2018 - George Mari
				// This following call to setParameter seems to messing up our ending } characters 
				// for the JSON in our dm.  It goes from }}}} at the end, to }}}
        ...
        if (map.oauth_nonce == null) {
			...
			// 23-NOV-2018 - George Mari
			// When message.parameters is a complex object, like that needed for sending a direct message,
			// the sign function below does not handle the complex object properly, I think.
