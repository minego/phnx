...
Packages: filename
	...
	@echo "Description: A remix of phnx for all webOS devices"		>> Packages
	...
	@echo 	"Source: { "													\
			...
			"\"Icon\":\"http://www.minego.net/preware/macaw/icon.png\", "	\
			"\"Type\":\"Application\", "									\
			...
			"\"Screenshots\":["												\
			"	\"http://www.minego.net/preware/macaw/screenshot1.png\","	\
			"	\"http://www.minego.net/preware/macaw/screenshot2.png\""	\
			"], "															\
			"\"FullDescription\":\""										\
